import{q as h,r as o,s as e,t as p,v as t,w as m,x as n,y as d,z as F,A as f,C as E,D as v,E as M}from"./index.15317b0e.js";import{g as u,h as I,j as B}from"./index.e86b6ae7.js";import{al as i,bH as H,bI as V}from"./index.bde27d78.js";import{I as x}from"./Layout.f2379779.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function k(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}const A={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":d,apk:x,db:u,md:F,epub:I,iso:B,m3u8:t,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:k,ai:D},L=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(A))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return V;case l.VIDEO:return t;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},N=a=>L(a.type,H(a.name));export{l as O,N as g};
